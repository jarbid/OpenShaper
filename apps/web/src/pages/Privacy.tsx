    ...
    <>
      ...
      <Container className="py-14">
        <div className="prose-shaper reveal">
          ...
          <p>
            Every visitor starts here, and it never changes unless you say so. No cookies, no
            localStorage, no persistent identity — each page load is independent, so there's
            nothing to consent to. We only see: anonymous pageviews, three feature-usage events
            (loading a starter template, saving, and exporting a board), and lightweight UX health
            signals (page load speed, rapid frustrated clicks, clicks on things that don't respond).
            None of it is tied to who you are, and it never leaves this anonymous mode on its own.
          </p>
