...
export const DEFAULT_DESCRIPTION =
  'Design surfboards in your browser with OpenShaper — a free, open-source CAD app. Draw outlines, rocker and cross-sections, see live volume and weight, preview in 3D, and export STEP, STL, DXF and PDF. No account, no paywall, runs entirely on your machine.';
