...
export const DEFAULT_DESCRIPTION =
  'Design surfboards in your browser with OpenShaper — free, open-source surfboard CAD. Draw outlines, rocker and cross-sections, watch volume and weight update as you go, and export STEP, STL, DXF and 1:1 printable PDF. Nothing to install.';
